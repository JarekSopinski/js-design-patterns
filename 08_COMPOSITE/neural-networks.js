/**
 * Problem: we want to connect Neuron (single) to NeuronLayer (collection).
 */

// https://stackoverflow.com/questions/29879267/
var aggregation = (baseClass, ...mixins) => {
    // allow to extend several classes
...
class Neuron extends Connectable {
    ...
    // BAD - works only on single neuron
    // connectTo(other){
    //     this.out.push(other);
    //     other.in.push(this);
    // }
    ...
    // masquarade Neuron to act as iterable object (without this for loop wouldn't work)
    [Symbol.iterator](){
        let returned = false;
        return {
            next: () => ({
