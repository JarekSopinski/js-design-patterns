/**
 * Implementing serializer - as a better alternative to deep copy, since we won't miss any nested objects/props.
 * But still flawed, because we've to remember to provide all types.
 */
