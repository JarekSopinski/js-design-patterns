class GraphicObject {
    // Can act either as a group of graphic objects or a standalone object.
    ...
    toString() {
        // works both for single objects and collections, therefore it implements composite pattern
        let buffer = [];
        this.print(buffer, 0);
        return buffer.join('');
    }
