    ...
    generate(size) {
        ...
        do {
            ...
            for (let i = 0; i < size; ++i)
              result.push(this.generator.generate(size));
          } while (!this.verifier.verify(this.splitter.split(result)));
          return result;
    }
}

const sq = new MagicSquareGenerator();
console.log(sq.generate(3));